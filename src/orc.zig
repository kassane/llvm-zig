...
pub const LLVMOrcCSymbolDependenceGroup = extern struct {
...
pub extern fn LLVMOrcMaterializationResponsibilityNotifyEmitted(MR: LLVMOrcMaterializationResponsibilityRef, SymbolDepGroups: [*c]LLVMOrcCSymbolDependenceGroup, NumSymbolDepGroups: usize) LLVMtype.LLVMErrorRef;
...
pub extern fn LLVMOrcCreateNewThreadSafeContextFromLLVMContext(Ctx: LLVMtype.LLVMContextRef) LLVMOrcThreadSafeContextRef;
